...
void test_ProxUrlExtractor_Extract2()
{
	...
	{
		if (ProxyURLExtractor::Extract(keys, test_data[i][0]) != test_data[i][1]) {
			std::string s = test_data[i][0];
			std::string t = test_data[i][1];
			std::string result = ProxyURLExtractor::Extract(keys, test_data[i][0]);
			fprintf(stderr, "test failed [%s]\n", test_data[i][0].data());
			all_test_ok = false;
			assert(false);
		}
...
void test_ProxUrlExtractor_Extract3()
{
	...
	std::string test_data[][2] = {
		...
		{ "http://www.microsofttranslator.com/bv.aspx???&from=&to=zh-chs&xxx&query=", "" },
		{ "http://www.microsofttranslator.com/bv.aspx??from=&to=zh-chs&xxx&&&&&query", "" },
		{ "http://www.microsofttranslator.com/bv.aspx?from=&to=zh-chs&xxx&query=http://www.bjtu.edu.cn", "http://www.bjtu.edu.cn" },
		{ "http://www.microsofttranslator.com/bv.aspx?from=&to=zh-chs&=xxx&quer=http://www.bjtu.edu.cn", "" },
		{ "http://www.microsofttranslator.com/bv.aspx?from=&to=zh-chs&xxx=&queryquery=http://www.bjtu.edu.cn", "" },
		{ "http://www.microsofttranslator.com/bv.aspx", "" },
		{ "http://www.microsofttranslator.com/bv.aspx???=&&&to=zh-chs&xxx&query=http://hnujug.com/", "http://hnujug.com/" },
		{ "http://www.microsofttranslator.com/bv.aspx?&&query=http://hnujug.com/", "http://hnujug.com/" },
		{ "http://www.microsofttranslator.com/bv.aspx?&from=&&=zh-chs&xxx&query=http://hnujug.com/", "http://hnujug.com/" },
		{ "http://www.microsofttranslator.com/bv.aspx?from=&to=zh-chs&xxx&query=http://www.bjtu.edu.cn", "http://www.bjtu.edu.cn" },
		{ "http://www.microsofttranslator.com/bv.aspx?from=&to=zh-chs&xxx&&yyy", "" },
		{ "http://www.microsofttranslator.com/bv.aspx?from=&to=zh-chs&xxx&=&yyy=xxquery", "" },
		{ "http://www.microsofttranslator.com/bv.aspx?from=&to=zh-chs&xxx&query=&yyy=xxyyy", "" }
	};
